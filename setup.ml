...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5fa47abf34811183726198191c4e3ff3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "test_net_lwt_client_and_effect_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      exec_custom = false;
                      exec_main_is =
                        "test_net_lwt_client_and_effect_server.ml"
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "M7\157\146\183\147\139cy\241\139\245\143\211\t#";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
